...
const BRACKET_Q = {
  q1:['o1','o2'], q2:['o3','o4'], q3:['o5','o6'], q4:['o7','o8']
};
const BRACKET_S = {
  s1:['q1','q2'], s2:['q3','q4']
};
...
// Resuelve los nombres reales para cualquier ronda eliminatoria
function resolveTeams(p) {
  const allBrackets = {...BRACKET, ...BRACKET_Q, ...BRACKET_S};
  if(!allBrackets[p.id]) return p;
  const [ridL, ridV] = allBrackets[p.id];
...
// IDs de partidos eliminatorios que pueden definirse por penales (16avos + octavos + cuartos + semis)
const BRACKET_SOURCE_IDS = new Set([
